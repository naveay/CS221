...
public class MyCrawler extends WebCrawler {
   ...
   /**
    ...
    public boolean shouldVisit(WebURL url) {
            ...
            return !FILTERS.matcher(href).matches() &&href.contains("ics.uci.edu")&&!href.contains("archive.ics.uci.edu/ml/datasets.html")&&!href.contains("calendar.ics.uci.edu")&&!href.contains("djp3-pc2.ics")&&!href.contains("drzaius.ics.uci.edu")&&!crawl.fre_url.containsKey(url.getURL());
    }
